...
alias restart='reboot'; alias sd='shutdown'; alias re='reboot'
...
alias fsl='ln -sfn "$(readlink "$*" | sed s/'$\n'//)" "$*"'
...
alias sudon='su -c nautilus'; alias gitc='git commit -am'; alias gitp='git push'
alias b='brave-browser &'; alias e='exit'; alias jnl='jupyter-server list'
alias gits='git status && git log --graph --oneline'
...
alias vv='vim ~/.vimrc'; alias vb='vim ~/Poker-Odds/env/.bashrc'
alias vpo='vim ~/Poker-Odds/poker_odds.py'
